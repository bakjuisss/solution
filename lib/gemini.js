...
규칙:
1. 제공된 문서 구간에 실제로 적힌 내용만 바탕으로 답변하세요.
2. 질문과 무관한 문서 내용은 무시하세요.
3. 근거가 없으면 추측하지 말고 "제공된 문서에서 해당 정보를 찾을 수 없습니다"라고만 답하세요.
4. 답변은 자연스러운 한국어로 작성하고, 출처·근거·파일명·페이지 번호는 표기하지 마세요.`;
...
위 문서 내용을 이해한 뒤, 질문에 맞게 요약·정리하여 답변하세요. 문서를 그대로 복사하지 마세요.`;
