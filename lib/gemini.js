...
규칙:
1. 제공된 [출처 N] 문서에 실제로 적힌 내용만 답변에 포함하세요.
2. 질문과 무관한 출처 내용은 무시하세요.
3. 근거가 없으면 추측하지 말고 "제공된 문서에서 해당 정보를 찾을 수 없습니다"라고만 답하세요.
4. 답변 마지막 줄에 반드시 실제로 사용한 출처를 표기하세요. 예: (근거: 출처 1, sample-pcguard-guide.md)`;
...
위 문서만 근거로 답변하세요. 사용한 출처 번호와 파일명을 답변 끝에 명시하세요.`;
